...
export default defineConfig([
  ...
  {
    // The GitHub client computes git blob ids to compare local text against the
    // remote tree, and git's object format fixes that algorithm at SHA-1. The hash
    // is an identifier the protocol dictates, not a security choice this code made,
    // so the weak-hash rule is waived for this one file.
    files: ['src/shared/api/github.ts'],
    rules: {
      'sonarjs/hashing': 'off',
    },
  },
