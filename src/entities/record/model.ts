...
export interface BaseContent {
  ...
  /** Pinned entries lead their section on the site, ascending, in previews and full pages alike. */
  pin?: number;
}
...
export interface Experience extends BaseContent {
  ...
  link?: string;
  /** One-line summary the site's previews show; the body's first line stands in when absent. */
  desc?: string;
}
