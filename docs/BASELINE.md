...
| `CHANGELOG.md` | The project is a versioned package that consumers upgrade through (see CONVENTIONS.md). This panel versions no releases, so it carries none. |
